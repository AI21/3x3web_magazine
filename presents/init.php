...
//フォームデータを受け取るメールアドレス
define('MAILTO','ligatokai@gmail.com');

//差出人名
define('FROMNAME',"リーガ東海事務局");

//受け取る時の件名
define('MAILSUBJECT','[3x3 WEB MAGAZINE]プレゼント応募');

//自動返信の件名
define('REPSUBJECT','[3x3 WEB MAGAZINE]プレゼント応募 内容控え');
...
3x3 WEB MAGAZINEへのアンケート＆プレゼント応募ありがとうございました。

アンケートについては今後の紙面ならびにWEB作りの参考にさせていただきます。

プレゼント応募については「当選者への連絡のみ」後日させていただきますので、落選の場合の連絡はいたしませんのでご了承ください。
...
────────────────────────────────────
3x3 MAGZINE 編集部
http://www.3x3magazine.com/
info@3x3magazine.com
────────────────────────────────────
EOM;
...
$inputs = array(
	'enqA'=>' 7月号でおもしろかったページ、記事',
	'enqAothor'=>' 7月号でおもしろかったページ、記事:その他',
	'enqB'=>'今後3x3MAGAZINEで取り入れて欲しい、期待する企画',
	'enqBplayer'=>'希望選手特集',
	'enqBothor'=>'今後3x3MAGAZINEで取り入れて欲しい、期待する企画：その他',
	// 'present'=>'プレゼント希望No',
	'age'=>'年齢',
	'sex'=>'性別',
	'email'=>'E-Mail'
